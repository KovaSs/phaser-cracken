...
function getUnixProxyScript(): string {
  return (
    [
      ...
      '# HTTPS_PROXY breaks ALL outbound HTTPS, but NO_PROXY whitelists',
      '# CDN domains so marketplace/chatbot still work. Go\'s NO_PROXY uses',
      '# .domain suffix matching: .phaser.io matches cdn.phaser.io but',
      '# NOT phaser.io itself, so auth fails and other features work.',
      'export HTTPS_PROXY="http://127.0.0.1:1"',
      'export NO_PROXY=".phaser.io,phasereditor2d.com,github.com,localhost,127.0.0.1"',
      "",
...
function getWindowsProxyScript(): string {
  return (
    [
      ...
      "set NO_PROXY=.phaser.io;phasereditor2d.com;github.com;localhost;127.0.0.1",
      "",
      "set FOUND=0",
      "for %%a in (%*) do (",
