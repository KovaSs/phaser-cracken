...
3. **การตรวจสอบไบนารี Go (การเริ่มต้นเซิร์ฟเวอร์)** — ไบนารี Go เก็บประทับเวลาความล้มเหลวในการตรวจสอบสิทธิ์ใน `server.log` เมื่อระยะเวลาผ่อนผัน 96 ชั่วโมงหมดลง มันจะปฏิเสธที่จะเริ่มทำงาน พร็อกซีจะตัดทอน `server.log` และ `auth-failure-v1.log` ทุกครั้งที่เรียกใช้ ทำให้ได้รับระยะเวลาผ่อนผันใหม่ทุกครั้งที่เปิดแก้ไข
