...
তিনটি সুরক্ষা স্তর বাইপাস করা হয়:
...
3. **Go বাইনারি চেক (সার্ভার স্টার্টআপ)** — Go বাইনারি `server.log`-এ অথেনটিকেশন ব্যর্থতার টাইমস্ট্যাম্প সংরক্ষণ করে। 96-ঘন্টার গ্রেস পিরিয়ড শেষ হলে, এটি শুরু হতে অস্বীকার করে। প্রোক্সি এখন প্রতিটি আহ্বানে `server.log` এবং `auth-failure-v1.log` খালি করে দেয়, যা সম্পাদক প্রতিবার চালু হলে একটি নতুন গ্রেস পিরিয়ড প্রদান করে।
